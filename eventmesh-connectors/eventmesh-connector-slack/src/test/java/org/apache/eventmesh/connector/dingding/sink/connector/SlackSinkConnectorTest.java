...
import org.apache.eventmesh.connector.slack.common.constants.ConnectRecordExtensionKeys;
import org.apache.eventmesh.connector.slack.config.SlackMessageTemplateType;
...
public class SlackSinkConnectorTest {
    ...
    @Spy
    private SlackSinkConnector connector;
    ...
    public void setUp() throws Exception {
        ...
        SlackSinkConfig sinkConfig = (SlackSinkConfig) ConfigUtil.parse(connector.configClass());
